...
export interface ApiCarCar extends Schema.CollectionType {
  ...
  attributes: {
    ...
    year_of_release: Attribute.String;
    ...
    modification: Attribute.String;
    availability: Attribute.String;
    marks: Attribute.Relation<'api::car.car', 'manyToMany', 'api::mark.mark'>;
    name: Attribute.String;
...
export interface ApiMarkMark extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cars: Attribute.Relation<'api::mark.mark', 'manyToMany', 'api::car.car'>;
